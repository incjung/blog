...
기본으로 현재 타임존을 원하는 시간 존으로 바꾸는 것이다. 그런데 =IANA Time Zone= 이름을 알고 있어야 한다. 모든 나라의 IANA(Internet Assigned Numbers Authority) 이름을 알고 있는 사람은 없을테고, 이 부분을 어떻게 사용하기 쉽게 만들지는 고민을 해봐야겠다
